...
@Component({
  selector: 'app-onlyfeedback',
  templateUrl: './onlyfeedback.component.html',
  styleUrls: ['./onlyfeedback.component.scss']
})
export class OnlyfeedbackComponent {
  UserArray : any[] = [];
  ...
  getAllUsers()
  { 
    this.http.get("https://localhost:7151/api/User/GetUser")
